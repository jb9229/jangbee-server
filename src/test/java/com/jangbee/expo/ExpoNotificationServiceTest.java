...
//        String token = "ExponentPushToken[eimkOmCQ17ppKOc90zAJoI]"; //채범
        ...
        tokenList.add("ExponentPushToken[eimkOmCQ17ppKOc90zAJoI]");
        tokenList.add("ExponentPushToken[7ClYvcCbF-fuDCUEnus-u9]");
